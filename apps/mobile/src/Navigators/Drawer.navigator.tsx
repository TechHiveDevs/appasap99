...
import ListAnimalScreen from "../Entities/Animal/List.animal.screen";
import ShowAnimalScreen from "../Entities/Animal/Show.animal.screen";
  ...
  return (
    <Stack.Navigator {...stackrops}>
      ...
      />
        ...
        <Stack.Screen
            name="ListAnimalScreen"
            component={ListAnimalScreen}
            options={screenOptions}
          />
          <Stack.Screen
          name="ShowAnimalScreen"
          component={ShowAnimalScreen}
          options={screenOptions}
        />
